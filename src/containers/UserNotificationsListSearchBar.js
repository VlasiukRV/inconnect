...
class UserNotificationsListSearchBar extends Component {
  ...
  render() {
    ...
    return <div>
             <input type='text' className='form-control' placeholder='Search notifacation by name...' value={ filters.term } onChange={ this.handleTermChange.bind(this) } />
           </div>
  }
  ...
  handleTermChange(event) {
    ...
    changeFilters(this.state.actionInitiator, {
      term: term
    })
  }
