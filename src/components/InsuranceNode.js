...
import '../stylesheets/InsuranceNodeStyle.css'
...
class InsuranceNode extends Component {
  ...
  render() {
    ...
    const {insuranceNode} = this.props
    ...
    return (
      <div>
        <p className='insuranceName'>
          ...
          <input type='number' className='form-control insuranceValue' placeholder='Search device by name...' value={ insuranceNode.value } onChange={ this.handleValueChange.bind(this) } {...opts}
          />
        </p>
        <p>
          <div dangerouslySetInnerHTML={ { __html: insuranceNode.description } } />
        </p>
        <p></p>
